...
//Asan
  tp_init();    // Initialize temperature loop    //**選單 必要
//  plan_init();  // Initialize planner;  //選單不需要此項
//  watchdog_init();                        //選單不需要此項
//  st_init();    // Initialize stepper, this enables interrupts!   //選單不需要此項
//  setup_photpin();                     //選單不需要此項
//  servo_init();                         //選單不需要此項
