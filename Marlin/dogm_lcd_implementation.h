...
static void lcd_implementation_status_screen()
{
 ...
 u8g.print(ftostr5(current_position[X_AXIS]));
 /*u8g.drawPixel(8,33);
 u8g.drawPixel(8,35);
...
//Asan check  ==> ON OFF select
#define lcd_implementation_drawmenu_setting_edit_bool_selected(row, pstr, pstr2, data) lcd_implementation_drawmenu_setting_edit_generic_P(row, pstr, '>', (*(data))?PSTR(MSG_ON):PSTR(MSG_OFF))
//Asan for bool string 
#define lcd_implementation_drawmenu_setting_edit_str_bool_selected(row, pstr, pstr2, data) lcd_implementation_drawmenu_setting_edit_generic_P(row, pstr, '>', (*(data))?PSTR(MSG_MODE_CONTINUE):PSTR(MSG_MODE_COUNTER))


//Asan check ==> No use
#define lcd_implementation_drawmenu_setting_edit_bool(row, pstr, pstr2, data) lcd_implementation_drawmenu_setting_edit_generic_P(row, pstr, ' ', (*(data))?PSTR(MSG_ON):PSTR(MSG_OFF))
//Asan check need for bool string
#define lcd_implementation_drawmenu_setting_edit_str_bool(row, pstr, pstr2, data) lcd_implementation_drawmenu_setting_edit_generic_P(row, pstr, ' ', (*(data))?PSTR(MSG_MODE_CONTINUE):PSTR(MSG_MODE_COUNTER))
